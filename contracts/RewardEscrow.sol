...
contract RewardEscrow is Owned, IRewardEscrow {
     ...
     * These are the times at which each given quantity of DEM vests. */
    ...
    /**
     * @notice set the synthetix contract address as we need to transfer DEM when the user vests
     */
    ...
    /**
     * @notice Get the quantity of DEM associated with a given schedule entry.
     */
    ...
    function _appendVestingEntry(address account, uint quantity) internal {
        ...
        if (scheduleLength == 0) {
            ...
            /* Disallow adding new vested DEM earlier than the last one.
     ...
     * @param quantity The quantity of DEM that will be escrowed.
     */
    ...
    /**
     * @notice Allow a user to withdraw any DEM in their schedule that have vested.
     */
