...
contract BaseRewardEscrowV2 is Owned, IRewardEscrowV2, LimitedSetup(8 weeks), MixinResolver {
    ...
    /**
     * @notice Create an escrow entry to lock DEM for a given duration in seconds
     ...
     * @param duration The duration that DEM will be emitted.
     */
