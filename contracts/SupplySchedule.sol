...
contract SupplySchedule is Owned, ISupplySchedule {
    ...
    // The number of DEM rewarded to the caller of Synthetix.mint()
    ...
    /**
     * @return The amount of DEM mintable for the inflationary supply
     */
     ...
     * @param supplyMinted the amount of DEM the total supply was inflated by.
     * */
    ...
    /**
     * @notice Sets the reward amount of DEM for the caller of the public
     * function Synthetix.mint().
     * This incentivises anyone to mint the inflationary supply and the mintr
     * Reward will be deducted from the inflationary supply and sent to the caller.
     * @param amount the amount of DEM to reward the minter.
     * */
    ...
    /**
     * @notice Emitted when the DEM minter reward amount is updated
     * */
